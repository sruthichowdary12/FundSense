...
<div class="recent-posts-container">
    ...
    <!-- Row 2 -->
    <a href="post-title-3.jsp" class="recent-post">
        <div class="recent-image"><img src="image3.jpg" alt="Recent Post Image 3"></div>
        <h3 class="recent-title">Post Title 3</h3>
        <span class="recent-date">November 1, 2024</span>
    </a>
    <a href="post-title-4.jsp" class="recent-post">
        <div class="recent-image"><img src="image4.jpg" alt="Recent Post Image 4"></div>
        <h3 class="recent-title">Post Title 4</h3>
        <span class="recent-date">November 5, 2024</span>
    </a>

    <!-- Row 3 -->
    <a href="post-title-5.jsp" class="recent-post">
        <div class="recent-image"><img src="image5.jpg" alt="Recent Post Image 5"></div>
        <h3 class="recent-title">Post Title 5</h3>
        <span class="recent-date">November 10, 2024</span>
    </a>
    <a href="post-title-6.jsp" class="recent-post">
        <div class="recent-image"><img src="image6.jpg" alt="Recent Post Image 6"></div>
        <h3 class="recent-title">Post Title 6</h3>
        <span class="recent-date">November 15, 2024</span>
    </a>
