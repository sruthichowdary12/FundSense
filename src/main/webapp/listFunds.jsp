...
<body>
    <div class="container mt-5">
        ...
        <a href="/admindashboard" class="btn btn-primary mb-3">Back</a>
                ...
                <c:forEach items="${funds}" var="fund">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/mutualfunds/edit/${fund.fundId}" class="btn btn-warning btn-sm">Edit</a>
                            <a href="/mutualfunds/delete/${fund.fundId}" class="btn btn-danger btn-sm" 
